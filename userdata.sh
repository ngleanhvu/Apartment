...
GIT_REPO_URL="https://github.com/ngleanhvu/Apartment.git"
#GIT_REPO_URL="https://<your_username>:<your_PAT>@github.com/codewithmuh/django-aws-ec2-autoscaling.git"

# Replace {YOUR_PROJECT_MAIN_DIR_NAME} with your actual project directory name
PROJECT_MAIN_DIR_NAME="Apartment"

# Clone repository
git clone -b thanhan "$GIT_REPO_URL" "/home/ubuntu/$PROJECT_MAIN_DIR_NAME"
